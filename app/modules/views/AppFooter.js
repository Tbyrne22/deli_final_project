        ...
        <Grid container spacing={5}>
          <Grid item xs={6} sm={4} md={3}>
            <Grid
              ...
              spacing={2}
              sx={{ height: 120 }}
              aria-label="Social Links and Contact Information"
            >
              ...
              <Grid item aria-label="Contact Email">
          ...
          <Grid item xs={6} sm={4} md={2} aria-label="Navigation Links">
          ...
          <Grid item xs={6} sm={8} md={4} sx={{fontSize:16}} aria-label="Location Information">
            <Typography variant="h6" marked="left" gutterBottom>
              Location
            </Typography>
